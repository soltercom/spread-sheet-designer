...
/*    private static final double CELL_WIDTH = 75.0D;
    ...
    private final SpreadSheetControllerFixed controller;

    private ScrollBar hScrollBar = new ScrollBar();
    private ScrollBar vScrollBar = new ScrollBar();

    private final TextField[] columnHeaders = new TextField[MAX_COLUMN];
    private final TextField[] rowHeaders    = new TextField[MAX_ROW];
    private final TextField[][] cells       = new TextField[MAX_ROW][MAX_COLUMN];

    private final Form form;

    public SpreadSheetViewFixed() {
        form = new Form(this);
        initView();
        controller = new SpreadSheetControllerFixed(this);
    }
